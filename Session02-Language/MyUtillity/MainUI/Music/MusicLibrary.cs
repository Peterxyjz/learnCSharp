...
//clash:
//Khi ta xài class ta phải chỉ ra namespace của class, nơi class cư ngụ
//Java chỉ ra nơi class cư ngụ gọi là import ...
//C                                   #include <stdio.h>            
namespace MainUI.Music
{
    internal class MusicLibrary
    {
        //class chứa bên trong: biến + hàm
        //                      member: biến - instance varible (non-static), class varible (static) + method
